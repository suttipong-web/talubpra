...
/**
  ChangeLog
  1.0.3.2
  - Edit for support multiple form (by mAXsPeED)
...
class Securimage {
  ...
  function saveData()
  {
    $_SESSION['securimage_code_value'.$this->imgid] = strtolower($this->code);
  }
  ...
  function validate()
  {
    if ( isset($_SESSION['securimage_code_value'.$this->imgid]) && !empty($_SESSION['securimage_code_value'.$this->imgid]) ) {
      if ( $_SESSION['securimage_code_value'.$this->imgid] == strtolower(trim($this->code_entered)) ) {
        $this->correct_code = true;
        $_SESSION['securimage_code_value'.$this->imgid] = '';
      } else {
  ...
  {
    if (isset($_SESSION['securimage_code_value'.$this->imgid]) && !empty($_SESSION['securimage_code_value'.$this->imgid])) {
      return $_SESSION['securimage_code_value'.$this->imgid];
    } else {
      return '';
    }
  }
